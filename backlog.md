...
## 🔴 Критично
* [ ] SECURITY: Добавить whitelist для Telegram-пользователей. (Уже частично реализовано, требуется проверка)
* [ ] BUG: `magda_agent/main.py` не обрабатывает асинхронные ошибки.
